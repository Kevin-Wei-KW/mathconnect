...
function signupclick() {
	...
	//document.getElementById("button").style.transform = "scale(2)"
	//document.getElementById("button").style.fontSize = "10rem";
	//document.getElementById("button").style.borderRadius = "1rem";
